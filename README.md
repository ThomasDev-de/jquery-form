...
[![Version](https://img.shields.io/badge/version-1.0.5-blue.svg)](https://github.com/webcito/jquery-form)
...
A powerful, lightweight jQuery plugin designed to streamline form handling with AJAX and Bootstrap 5. It automates validation display, file
uploads, and provides a rich API for modern web applications.
...
The plugin automatically initializes for forms with `data-bs-toggle="form"` or `data-toggle="form"`. Initialization occurs immediately on
page load thanks to a MutationObserver, as well as for any forms added later (e.g., via AJAX). For batch operations, initialization is
performed efficiently using debouncing.
